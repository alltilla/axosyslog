...
/* Decode the message body in place according to its Content-Encoding header.
 * max_output_size bounds the decompressed size to guard against a
 * decompression bomb. A missing or identity encoding is a no-op. */
